...
#Region "----- メソッド -----"
    ...
    Public Sub New(ByVal questionNumber As Integer)
        ...
        _AnswerRadioButtons = {rdbAnswer1, rdbAnswer2, rdbAnswer3, rdbAnswer4}
...
#End Region
    ...
    Private Sub EndTest()
        Try
            ...
            ' 受講者ファイルをアップロードリストに追加
            '_upFileList.Add(DataManager.GetInstance.StudentFileName)
            ...
            ' アップロードファイルリスト追加
            '_upFileList.Add(DataManager.GetInstance.SynthesisResultDefine.SynthesisResultHeaderFileName)
            '_upFileList.Add(DataManager.GetInstance.SynthesisResultDefine.SynthesisResultDetailFileName)
            ' アップロード
...
#Region "----- イベント -----"
    ...
    ''' <param name="e"></param>
    ''' <remarks></remarks>
    Private Sub rdbAnswer_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles rdbAnswer1.CheckedChanged, rdbAnswer2.CheckedChanged, rdbAnswer3.CheckedChanged, rdbAnswer4.CheckedChanged
        Try
            _Log.Start()
