...
''' </summary>
''' <remarks></remarks>
Public Class ResultSummarySystem
...
#Region "----- メンバ変数 -----"
    ...
    ''' <summary>分類結果集計データリスト</summary>
    Private _ResultSummaryGroupList As New Generic.Dictionary(Of Integer, ResultSummaryGroup)
...
#Region "----- メソッド -----"
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Function GetResultSummaryGroupList() As Generic.Dictionary(Of Integer, ResultSummaryGroup)
        Return _ResultSummaryGroupList
    End Function
